...
var pulseGradient = pulseContext.createLinearGradient(
  0,
  0,
  canvasWidth,
  canvasHeight
...
var squareGradient = squareContext.createLinearGradient(
  0,
  0,
  canvasWidth,
  canvasHeight
...
var triangleGradient = triangleContext.createLinearGradient(
  0,
  0,
  canvasWidth,
  canvasHeight
...
var noiseGradient = noiseContext.createLinearGradient(
  0,
  0,
  canvasWidth,
  canvasHeight
